...
def get_query_LaMP_3(input_string):
    # 'review:' ifadesini büyük/küçük harf duyarsız arar ve 
    # önündeki/arkasındaki olası tuhaf boşlukları/noktaları tolere eder.
    match = re.search(r'review:\s*(.*)', input_string, re.IGNORECASE)
    if not match:
        return None
