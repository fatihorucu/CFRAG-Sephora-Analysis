...
class CETrainer(Trainer):
    ...
    # Değişiklik yapılan kısım burasıdır
    def compute_loss(self, model: CrossEncoder, inputs, **kwargs):
        """
        Gelen tüm ekstra argümanları (**kwargs) kabul eder, 
        böylece 'num_items_in_batch' gibi parametreler hataya yol açmaz.
        """
