...
parser.add_argument("--model_name",
                    ...
                    choices=['Qwen2-7B-Instruct-AWQ', 'Meta-Llama-3-8B-Instruct', 'Qwen2-7B-Instruct', 'Qwen2-1.5B-Instruct', 'Qwen2-1.5B-Instruct', 'Qwen2-1.5B-Instruct', 'Qwen2-1.5B-Instruct', 'Qwen2-1.5B-Instruct', 'Qwen2-1.5B-Instruct', 'Qwen2-1.5B-Instruct'])
...
if __name__ == "__main__":
    ...
    opts.base_addr = os.path.join(f"{opts.model_name}_outputs/", opts.task,
                                  opts.input_path)
    opts.model_path = 'Qwen/Qwen2-7B-Instruct-AWQ'
    ...
    print({k: "{:.6f}".format(v) for k, v in mean_scores.items()})
